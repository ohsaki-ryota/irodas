!function(d){var n=d.createElement('link');n.async=!0;n.defer=!0;n.media="all";n.rel="stylesheet";n.href="https://use.fontawesome.com/releases/v5.12.1/css/all.css";if(d.getElementsByTagName('head')[0]!==null){d.getElementsByTagName('head')[0].appendChild(n);}}(document);!function(d){var n=d.createElement('link');n.async=!0;n.defer=!0;n.rel="stylesheet";n.href="//irodas.local/wp-content/themes/luxeritas/style.async.min.css?v=1597655978";if(d.getElementsByTagName('head')[0]!==null){d.getElementsByTagName('head')[0].appendChild(n);}
n=d.createElement('link');n.async=!0;n.defer=!0;n.rel="stylesheet";n.href="https://fonts.googleapis.com/css?family=Noto+Sans+JP";if(d.getElementsByTagName('head')[0]!==null){d.getElementsByTagName('head')[0].appendChild(n);}}(document);var luxeGetSnsCount=function(h,i,j,k,f){var g=h.location.search,q=document.querySelector(j);if(window.jQuery&&q!=null){jQuery.ajax({type:"GET",url:"http://irodas.local/wp-admin/admin-ajax.php",data:{action:"thk_sns_real",sns:i,url:f},dataType:"text",async:true,cache:false,timeout:30000,success:function(b){if(isFinite(b)&&b!==""){q.textContent=String(b).replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1,")}else{if(typeof(b)==="string"&&b!==""){var a=b.slice(0,11);q.textContent=a}else{q.textContent="!"}}},error:function(){q.textContent="!"}})}else{if(q!=null)q.textContent="?";}};!function(b,d){b.addEventListener("load",function c(){var m=d.getElementsByClassName("sns-count-true"),g=d.getElementsByClassName("sns-cache-true"),r=d.getElementsByClassName("feed-count-true");if(m.length>0||g.length>0){var k=g.length>0?g[0]:m[0],f=k.getAttribute("data-luxe-permalink"),e=k.getAttribute("data-incomplete"),l=e!=null?e.split(","):"";if(g.length>0&&window.jQuery){var s=jQuery.ajax({type:"POST",url:"http://irodas.local/wp-admin/admin-ajax.php",data:{action:"thk_sns_cache",url:f},dataType:"text",async:true,cache:false}),h=setInterval(function(){if(s&&s.readyState>0){s.abort();clearInterval(h)}},500)}
